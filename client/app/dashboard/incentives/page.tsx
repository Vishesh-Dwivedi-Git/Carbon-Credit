...
// StatCard Component (Adapted from MetricCard, without trend)
        ...
        <AnimatePresence>
            {show && (
                <motion.div
                    ...
                    exit={{ opacity: 0, y: -50 }}
                    className="fixed z-50 flex items-start max-w-xs p-4 rounded-lg shadow-lg top-4 right-4 bg-primary text-primary-foreground"
                >
